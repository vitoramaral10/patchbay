...
## Biblioteca de servidores MCP

Cadastrar um upstream à mão é acertar endpoint, transporte e modo de credencial
na primeira tentativa — três campos em que errar não dá erro de formulário, dá
