...
> Estado: fatias **1, 2, 3, 4, 5, 6, 10, 13 e 16** do épico entregues — catálogo e
...
> authorization server essencial, o export/import da configuração em YAML e o
> empacotamento (binário multiplataforma por `goreleaser`, imagem Docker
> distroless). OAuth de upstream (fatias 7-8), sonda funcional (fatia 9),
> CIMD/DCR/redirect URI de loopback (fatia 11) e observabilidade (fatia 12)
> seguem pendentes.
>
